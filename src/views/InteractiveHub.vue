      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex items-center gap-2 ml-auto">
          <img
            ...
            alt="imicola 头像"
            class="w-7 h-7 rounded-full object-cover ring-2 ring-indigo-200 shadow-sm flex-shrink-0"
            @error="e => e.target.style.display='none'"
          />
          <span class="text-sm text-slate-500 mr-2">由 <span class="font-bold text-indigo-600">imicola</span> 大佬制作</span>
          <a
            href="https://github.com/imicola"
            target="_blank"
            rel="noopener noreferrer"
            class="flex items-center gap-1 text-sm text-indigo-500 hover:text-indigo-700 transition-colors"
          >
